                              ...
                              children: [
                                ...
                                AnimatedSwitcher(
                                  ...
                                  child: AnimatedSwitcher(
                                    ...
                                    child: controller.isHideButtomSheet.value == false
                                        ? Align(
                                                            ...
                                                            children: [
                                                              InkWell(
                                                                onTap: () {
                                                                  ...
                                                                  controller.enterOfferRateController.value.text = controller.amount.value.toStringAsFixed(Constant.currencyModel!.decimalDigits!);
                                                                },
                                                                child: Container(
                                                                  decoration: BoxDecoration(
                                                                    border: Border.all(color: AppColors.textFieldBorder),
                                                              ...
                                                              if (ownerUserModel?.subscriptionTotalOrders == "-1") {
                                                                ...
                                                                if (Constant.isSubscriptionModelApplied == false && Constant.adminCommission!.isEnabled == false) {
                                                                  ...
                                                                  if ((ownerUserModel?.subscriptionExpiryDate != null &&
                                                                          ownerUserModel?.subscriptionExpiryDate!.toDate().isBefore(DateTime.now()) == false) ||
                                                                      ownerUserModel?.subscriptionPlan?.expiryDay == '-1') {
                                                                    if (ownerUserModel?.subscriptionTotalOrders != '0') {
                                                                      controller.acceptOrder();
                                                                    } else {
                                                                      ShowToastDialog.showToast("Your order limit has reached their maximum order capacity. Please reach out to the owner.");
                                                                    }
                                                                  } else {
                                                                    ShowToastDialog.showToast("Your order limit has reached their maximum order capacity. Please reach out to the owner.");
                                                                  }
