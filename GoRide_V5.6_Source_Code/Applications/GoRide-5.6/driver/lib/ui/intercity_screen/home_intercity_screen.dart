                          ...
                          child: Padding(
                            ...
                            child: controller.isLoading.value == true
                                ...
                                : Column(
                                    ...
                                    children: [
                                      controller.selectedService.value.id == null
                                          ? Text("Intercity/Outstation feature is disable".tr)
                                          : Text("Intercity/Outstation feature is disable for ${Constant.localizationName(controller.selectedService.value.title)}".tr)
                                    ],
                                  ),
                          ),
                        ),
