                                          ...
                                          orderModel.status == Constant.rideComplete || orderModel.status == Constant.rideActive
                                              ? Container(
                                                  ...
                                                  child: Padding(
                                                      ...
                                                      child: Row(
                                                        children: [
                                                          Expanded(child: RideStatusChip(status: orderModel.status)),
                                                      ...
                                                      children: [
                                                        InkWell(
                                                          ...
                                                          child: Container(
                                                            ...
                                                            width: 44,
                                                            decoration: BoxDecoration(
                                                                color: themeChange.getThem() ? AppColors.darksecondprimary : AppColors.lightsecondprimary, borderRadius: BorderRadius.circular(5)),
                                          ...
                                          Visibility(
                                              ...
                                              child: ButtonThem.buildButton(
                                                ...
                                                onPress: () async {
                                                  ...
                                                  await FireStoreUtils.getDriverFirstOrderOrNot(driverId: orderModel.driverId!, orderType: 'intercity').then((value) async {
                                                    if (value == true) {
                                                      await FireStoreUtils.updateDriverIntercityReferralAmount(orderModel);
                                                    }
                                                  });

                                                  await FireStoreUtils.getCustomerFirstOrderOrNot(customerId: orderModel.userId!, orderType: 'intercity').then((value) async {
                                                    if (value == true) {
                                                  ...
                                                  if (orderModel.adminCommission?.amount != '0' && orderModel.adminCommission?.amount != '0.0' && orderModel.adminCommission?.amount != null) {
                                                    WalletTransactionModel adminCommissionWallet = WalletTransactionModel(
                                                        ...
                                                        userType: orderModel.ownerId == null ? "driver" : "onwer",
                                                  ...
                                                  await FireStoreUtils.setInterCityOrder(orderModel).then((value) async {
