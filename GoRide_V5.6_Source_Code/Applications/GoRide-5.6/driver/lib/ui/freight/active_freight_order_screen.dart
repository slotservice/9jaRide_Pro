...
class ActiveFreightOrderScreen extends StatelessWidget {
                                                ...
                                                ? ButtonThem.buildBorderButton(
                                                    ...
                                                    onPress: () async {
                                                      ...
                                                      try {
                                                        ...
                                                        await FireStoreUtils.getCustomer(orderModel.userId.toString()).then((value) async {
                                                          if (value != null) {
                                                            ...
                                                            await SendNotification.sendOneNotification(
                                                                token: value.fcmToken.toString(), title: 'Order complete!'.tr, body: 'Please complete your payment.'.tr, payload: playLoad);
                                                          }
                                                        });
                                                        ...
                                                        log("Complete freight order error :: $e\n$stackTrace");
                                              ...
                                              InkWell(
                                                onTap: () async {
                                                  ...
                                                  Get.to(ChatScreens(
                                                    ...
                                                    driverName: controller.driverUserModel.value?.fullName,
                                                    driverProfileImage: controller.driverUserModel.value?.profilePic,
  ...
  Dialog otpDialog(BuildContext context, ActiveInterCityOrderController controller, InterCityOrderModel orderModel) {
    final themeChange = Provider.of<DarkThemeProvider>(context);
            ...
            ButtonThem.buildButton(context, title: "OTP verify".tr, onPress: () async {
              if (orderModel.otp.toString() == controller.otpController.value.text) {
                ...
                try {
                  ...
                  log("OTP verify (pickup cargo) error :: $e\n$stackTrace");
                  ShowToastDialog.showToast("Something went wrong: $e");
                } finally {
                  ShowToastDialog.closeLoader();
                }
