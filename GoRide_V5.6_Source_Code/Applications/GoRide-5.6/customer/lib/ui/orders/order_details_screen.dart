                                                                        ...
                                                                        child: Column(
                                                                          children: [
                                                                            Padding(
                                                                              ...
                                                                              child: DriverView(driverId: driverModel.id.toString(), driverOfferRate: driverIdAcceptReject.offerAmount),
                                                                            ),
                                                                            const SizedBox(
                                                                              height: 10,
                                                                            ),
                                                                                  ...
                                                                                  Expanded(
                                                                                    child: ButtonThem.buildButton(
                                                                                      ...
                                                                                      onPress: () async {
                                                                                        ShowToastDialog.showLoader("Please wait".tr);
                                                                                        try {
                                                                                          final freshOrderDoc = await FireStoreUtils.fireStore.collection(CollectionName.orders).doc(orderModel.id).get();
                                                                                          final freshOrder = OrderModel.fromJson(freshOrderDoc.data() ?? {});
