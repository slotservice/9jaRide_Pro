                                                              ...
                                                              children: [
                                                                Row(
                                                                  children: [
                                                                    Container(
                                                                      decoration: BoxDecoration(
                                                                          color: themeChange.getThem() ? AppColors.lightGray : AppColors.darkGray, borderRadius: BorderRadius.circular(100)),
                                                                      child: Padding(
                                                                        padding: const EdgeInsets.symmetric(horizontal: 14, vertical: 16),
                                                                        child: Text(
                                                                          couponModel.type == "fix" ? Constant.amountShow(amount: couponModel.amount) : "${couponModel.amount}%",
                                                                          style: GoogleFonts.poppins(
                                                                              fontWeight: FontWeight.w500, color: themeChange.getThem() ? AppColors.darkBackground : AppColors.background),
                                                                        ),
                                                                      ),
                                                                    ),
                                                                    const SizedBox(
                                                                    ...
                                                                    Column(
                                                                      ...
                                                                      children: [
                                                                        Text(
                                                                          Constant.localizationTitle(couponModel.title),
                                                                      ...
                                                                      child: Row(
                                                                        children: [
                                                                          SvgPicture.asset('assets/icons/ic_offer_image.svg',
                                                                              color: themeChange.getThem() ? AppColors.lightGray : AppColors.darkGray,
