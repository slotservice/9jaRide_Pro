                                  ...
                                  InkWell(
                                      onTap: () async {
                                        if (Constant.selectedMapType == 'osm') {
                                          ...
                                          if (result != null) {
                                            PlaceModel firstPlace = result;
                                            final lat = firstPlace.coordinates.latitude;
                                            final lng = firstPlace.coordinates.longitude;
                                            final address = firstPlace.address;
                                            final city = firstPlace.city;
                                            controller.sourceCityController.value.text = city.toString();
                                          ...
                                          Get.to(const GoogleMapSearchPlacesApi())!.then((value) async {
                                            if (value != null) {
                                              ...
                                              controller.sourceLocationLAtLng.value =
                                                  LocationLatLng(latitude: placeDetailsModel.result!.geometry!.location!.lat, longitude: placeDetailsModel.result!.geometry!.location!.lng);
                                              controller.checkSurgeZoneList();
                                      ...
                                      onTap: () async {
                                        if (Constant.selectedMapType == 'osm') {
                                          ...
                                          if (result != null) {
                                            ...
                                            final address = firstPlace.address;
                                            final city = firstPlace.city;
                                            controller.destinationCityController.value.text = city.toString();
                                  ...
                                  InkWell(
                                      onTap: () async {
                                        BottomPicker.dateTime(
                                          ...
                                          buttonSingleColor: AppColors.lightprimary,
                                        ).show(context);
                                      },
                                      child: TextFieldThem.buildTextFiled(
                                        context,
                                                        ...
                                                        children: [
                                                          ...
                                                          Expanded(
                                                            ...
                                                            controller.selectedFreightVehicle.value.id != null && controller.selectedFreightVehicle.value.id!.isNotEmpty
                                                                ? Constant.localizationName(controller.selectedFreightVehicle.value.name)
                                        ...
                                        if (controller.sourceLocationLAtLng.value.latitude != null && controller.destinationLocationLAtLng.value.latitude != null) {
                                          for (int i = 0; i < controller.zoneList.length; i++) {
                                            if (Constant.isPointInPolygon(
                                              LatLng(double.parse(controller.sourceLocationLAtLng.value.latitude.toString()), double.parse(controller.sourceLocationLAtLng.value.longitude.toString())),
                                        ...
                                        children: [
                                          ...
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                Text(
                                                  Constant.localizationName(freightModel.name),
                                                  style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w600),
                                                ),
                                                Text(
                                                  Constant.localizationDescription(freightModel.description),
