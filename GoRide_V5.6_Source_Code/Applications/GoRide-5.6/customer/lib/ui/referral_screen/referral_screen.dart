...
class ReferralScreen extends StatelessWidget {
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              children: [
                                ...
                                Text(
                                  "Earn ${Constant.amountShow(amount: Constant.referralCustomerAmount.toString())} each".tr,
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      "Invite 9jaRide Pro to sign up using your link and you’ll get ${Constant.amountShow(amount: Constant.referralCustomerAmount.toString())}  ".tr,
  ...
  Future<void> share(ReferralController controller) async {
    ...
    await Share.share(
      ...
      'Hey there, thanks for choosing 9jaRide Pro. Hope you love our product. If you do, share it with your friends using code ${controller.referralModel.value.referralCode.toString()} and get ${Constant.amountShow(amount: Constant.referralCustomerAmount)}.'
          .tr,
    );
  }
}
