                    ...
                    child: controller.isLoading.value
                        ...
                        : Container(
                            ...
                            child: Padding(
                              ...
                              child: StreamBuilder(
                                  stream: FireStoreUtils.fireStore.collection(CollectionName.ordersIntercity).doc(controller.orderModel.value.id).snapshots(),
                      ...
                      ButtonThem.buildButton(
                        ...
                        onPress: () async {
                          ...
                          if (controller.selectedPaymentMethod.value == controller.paymentModel.value.strip!.name) {
                            ...
                            controller.paypalPaymentSheet(controller.calculateAmount().toStringAsFixed(Constant.currencyModel!.decimalDigits!), context1);
                            ...
                            controller.midtransMakePayment(context: context, amount: controller.calculateAmount().toString());
                          } else if (controller.selectedPaymentMethod.value == controller.paymentModel.value.orangePay!.name) {
                            controller.orangeMakePayment(context: context, amount: controller.calculateAmount().toString());
                          } else if (controller.selectedPaymentMethod.value == controller.paymentModel.value.xendit!.name) {
                            controller.xenditPayment(context, controller.calculateAmount());
