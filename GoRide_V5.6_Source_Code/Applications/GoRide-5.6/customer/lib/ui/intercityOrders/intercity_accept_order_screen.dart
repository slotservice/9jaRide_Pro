                                                                              ...
                                                                              child: Row(
                                                                                children: [
                                                                                  ...
                                                                                  FutureBuilder<DriverIdAcceptReject?>(
                                                                                      future: FireStoreUtils.getInterCItyAcceptedOrders(orderModel.id.toString(), driverModel.id!),
                                                                                      builder: (context, snapshot) {
                                                                                        switch (snapshot.connectionState) {
                                                                                          case ConnectionState.waiting:
                                                                                            return SizedBox();
                                                                                          case ConnectionState.done:
                                                                                            if (snapshot.hasError) {
                                                                                              ...
                                                                                              DriverIdAcceptReject driverIdAcceptReject = snapshot.data!;
                                                                                              return Text(Constant.amountShow(amount: driverIdAcceptReject.offerAmount ?? '0.0'),
