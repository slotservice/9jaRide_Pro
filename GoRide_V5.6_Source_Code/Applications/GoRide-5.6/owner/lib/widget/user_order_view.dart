...
class UserView extends StatelessWidget {
  ...
  const UserView({super.key, this.userId, this.amount});
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    if (amount != null && amount != '0.0' && amount != '0')
                                      Text(
...
class DriverView extends StatelessWidget {
  ...
  const DriverView({super.key, this.userId, this.amount});

  @override
  Widget build(BuildContext context) {
    final themeChange = Provider.of<DarkThemeProvider>(context);
    return FutureBuilder<DriverUserModel?>(
        future: FireStoreUtils.getDriverProfile(userId.toString()),
        builder: (context, snapshot) {
          switch (snapshot.connectionState) {
            case ConnectionState.waiting:
              return const SizedBox();
