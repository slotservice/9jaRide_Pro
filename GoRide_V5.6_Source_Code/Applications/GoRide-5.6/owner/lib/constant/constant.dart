...
import 'package:owner/model/ChatVideoContainer.dart';
...
import 'package:owner/model/order/location_lat_lng.dart';
...
class Constant {
  ...
  static bool isVerifyOwnerDocument = false;
  ...
  static Widget showEmptyView({required String message}) {
    return Center(
      child: Text(message, textAlign: TextAlign.center, style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 18)),
    );
  }
      ...
      builder: (context, child) {
        ...
        return Theme(
          data: ThemeData.light().copyWith(
            primaryColor: themeChange.getThem() ? AppColors.darksecondprimary : AppColors.lightsecondprimary,
            colorScheme: ColorScheme.light(primary: themeChange.getThem() ? AppColors.darksecondprimary : AppColors.lightsecondprimary),
  ...
  static String amountShow({required String? amount}) {
    if (Constant.currencyModel?.symbolAtRight == true) {
      return "${double.parse(amount ?? '0.0').toStringAsFixed(Constant.currencyModel!.decimalDigits!)} ${Constant.currencyModel!.symbol.toString()}";
    } else {
      return "${Constant.currencyModel?.symbol.toString()} ${double.parse(amount ?? '0.0').toStringAsFixed(Constant.currencyModel!.decimalDigits!)}";
    }
  }
