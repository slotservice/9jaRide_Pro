...
class PayStackURLGen {
  static Future payStackURLGen({required String amount, required String secretKey, required String currency, required OwnerUserModel userModel}) async {
  ...
  static Future<String> getPayHTML({required String amount, required Payfast payFastSettingData, required OwnerUserModel userModel}) async {
