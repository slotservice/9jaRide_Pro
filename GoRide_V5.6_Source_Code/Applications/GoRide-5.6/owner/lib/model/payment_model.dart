class PaymentModel {
  ...
  PaymentModel(
      {this.flutterWave, this.payStack, this.strip, this.wallet, this.mercadoPago, this.razorpay, this.paytm, this.payfast, this.cash, this.paypal, this.xendit, this.orangePay, this.midtrans});
