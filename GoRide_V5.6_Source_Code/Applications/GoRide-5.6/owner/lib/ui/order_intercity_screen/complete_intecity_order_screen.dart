...
import 'package:owner/model/order/complete_intercity_order_controller.dart';
...
import 'package:owner/widget/user_order_view.dart';
                                  ...
                                  child: SingleChildScrollView(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        UserView(userId: controller.orderModel.value.userId.toString(), amount: controller.orderModel.value.finalRate.toString()),
                                        const SizedBox(
                                          height: 20,
                                        ),
                                        Text(
                                        ...
                                        DriverView(userId: controller.orderModel.value.driverId.toString()),
                                        const SizedBox(
                                          height: 10,
                                        ),
                                        const Padding(
                                        ...
                                        if (controller.orderModel.value.status == Constant.rideComplete)
