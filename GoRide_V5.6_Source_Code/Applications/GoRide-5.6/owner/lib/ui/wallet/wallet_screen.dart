...
import 'package:owner/ui/withdraw_history/withdraw_history_screen.dart';
...
class WalletScreen extends StatelessWidget {
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      Constant.amountShow(amount: controller.ownerUserModel.value.walletAmount.toString()),
                ...
                children: [
                  Expanded(
                    child: ButtonThem.buildBorderButton(
                      ...
                      title: "withdraw".tr,
                      onPress: () async {
                        if (double.parse(controller.ownerUserModel.value.walletAmount.toString()) <= 0) {
  ...
  Future paymentMethodDialog(BuildContext context, WalletController controller) {
  ...
  Future withdrawAmountBottomSheet(BuildContext context, WalletController controller) {
    return showModalBottomSheet(
        context: context,
        isScrollControlled: true,
                    ...
                    Row(
                      ...
                      children: [
                        ButtonThem.buildButton(
                          ...
                          title: "Withdrawal".tr,
                          onPress: () async {
                            if (double.parse(controller.ownerUserModel.value.walletAmount.toString()) < double.parse(controller.withdrawalAmountController.value.text)) {
                              ShowToastDialog.showToast("Insufficient balance".tr);
