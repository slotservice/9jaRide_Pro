...
import 'package:owner/controller/login_controller.dart';
...
import 'package:owner/ui/terms_and_condition/terms_and_condition_screen.dart';
                                ...
                                if (value.additionalUserInfo!.isNewUser) {
                                  ...
                                  await FireStoreUtils.userExitRole(value.user!.uid).then((userExit) async {
                                    if (userExit == '') {
                                      ...
                                      await FireStoreUtils.updateOwnerUser(userModel);
                                ...
                                await controller.signInWithApple().then((value) {
                                  ...
                                  if (value != null) {
                                    ...
                                    if (userCredential.additionalUserInfo!.isNewUser) {
                                      ...
                                      log("----->old user");
                                      FireStoreUtils.userExitRole(userCredential.user!.uid).then((userExit) async {
                                        if (userExit == '') {
                                          OwnerUserModel userModel = OwnerUserModel();
                                          userModel.id = userCredential.user!.uid;
                                          userModel.profilePic = userCredential.user!.photoURL;
