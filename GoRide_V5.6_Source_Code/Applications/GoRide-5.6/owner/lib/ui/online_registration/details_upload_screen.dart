...
import 'package:owner/controller/details_upload_controller.dart';
                                ...
                                Visibility(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text("Front Side of ${Constant.localizationTitle(controller.documentModel.value.title)}".tr,
                                ...
                                Visibility(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text("Back side of ${Constant.localizationTitle(controller.documentModel.value.title)}".tr,
                                            style: GoogleFonts.poppins(fontSize: 16, fontWeight: FontWeight.w600)),
                                        const SizedBox(
                                          height: 10,
                                        ),
