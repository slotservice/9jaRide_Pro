...
import 'package:owner/controller/online_registration_controller.dart';
...
import 'package:owner/ui/online_registration/details_upload_screen.dart';
                              ...
                              : Padding(
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      ...
                                      var contain = controller.ownerDocumentList.where((element) => element.documentId == documentModel.id);
                                      if (contain.isNotEmpty) {
                                        documents = controller.ownerDocumentList.firstWhere((itemToCheck) => itemToCheck.documentId == documentModel.id);
                                      }
