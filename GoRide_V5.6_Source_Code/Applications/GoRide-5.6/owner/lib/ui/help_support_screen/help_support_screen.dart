...
import 'package:owner/ui/chat_screen/FullScreenImageViewer.dart';
import 'package:owner/ui/chat_screen/FullScreenVideoViewer.dart';
import 'package:owner/ui/chat_screen/chat_screen.dart';
...
class HelpSupportScreen extends StatefulWidget {
  ...
  const HelpSupportScreen({super.key, this.userId, this.userName, this.userProfileImage, this.token, this.isShowAppbar});
            ...
            Expanded(
              child: GestureDetector(
                ...
                child: StreamBuilder<QuerySnapshot>(
                    stream: FireStoreUtils.fireStore.collection(CollectionName.chat).doc(FireStoreUtils.getCurrentUid()).collection("thread").orderBy('createdAt', descending: true).snapshots(),
                      ...
                      Padding(
                        ...
                        child: ClipRRect(
                          ...
                          child: CachedNetworkImage(
                            ...
                            imageUrl: widget.userProfileImage.toString(),
                            fit: BoxFit.cover,
                            placeholder: (context, url) => Constant.loader(isDarkTheme: themeChange.getThem()),
          ...
          : Column(
              ...
              children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text("Admin".tr, style: GoogleFonts.poppins(fontSize: 12, fontWeight: FontWeight.w400)),
                    Text(Constant.dateAndTimeFormatTimestamp(data.createdAt), style: GoogleFonts.poppins(fontSize: 12, fontWeight: FontWeight.w400)),
                  ],
                ),
              ],
