            ...
            Expanded(
              child: GestureDetector(
                ...
                child: StreamBuilder<QuerySnapshot>(
                    stream: FireStoreUtils.fireStore.collection(CollectionName.chat).doc(widget.orderId).collection("thread").orderBy('createdAt', descending: true).snapshots(),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      SizedBox(width: 5),
                      data.seen == true
                          ? Text("✓✓", style: GoogleFonts.poppins(fontSize: 10, color: AppColors.ratingColour, fontWeight: FontWeight.w400))
