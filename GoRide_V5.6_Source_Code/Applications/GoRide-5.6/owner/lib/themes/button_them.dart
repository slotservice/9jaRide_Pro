...
class ButtonThem {
      ...
      child: SizedBox(
        ...
        child: MaterialButton(
          ...
          child: Text(
            ...
            style: GoogleFonts.poppins(fontSize: txtSize, fontWeight: FontWeight.w600, color: textColor ?? (themeChange.getThem() ? AppColors.grey900 : AppColors.grey50)),
          ),
        ),
      ),
    );
  ...
  static Visibility roundButton(BuildContext context,
      {required String title,
      double btnHeight = 48,
      double txtSize = 14,
      double btnWidthRatio = 0.9,
    ...
    return Visibility(
      ...
      child: SizedBox(
        ...
        child: MaterialButton(
          ...
          color: bgColors ?? (themeChange.getThem() ? AppColors.darksecondprimary : AppColors.lightsecondprimary),
          child: Text(
            isTitleUperCase == true ? title.toUpperCase() : title,
            textAlign: TextAlign.center,
            style: GoogleFonts.poppins(fontSize: txtSize, fontWeight: fontWeight ?? FontWeight.w600, color: textColor ?? (themeChange.getThem() ? AppColors.grey900 : AppColors.grey50)),
          ),
        ),
      ),
    );
