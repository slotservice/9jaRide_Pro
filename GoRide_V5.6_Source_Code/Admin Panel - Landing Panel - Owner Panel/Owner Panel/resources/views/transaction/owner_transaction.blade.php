...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-5 align-self-center">
            ...
            <h3 class="text-themecolor">{{trans('lang.my_wallet_transactions')}}</h3>
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{trans('lang.my_wallet_transactions')}}</li>
            </ol>
        </div>
                    ...
                    <div class="card card-box-with-icon bg--1">
                        <div class="card-body d-flex justify-content-between align-items-center">
                            <div class="card-box-with-content">
                                <h4 class="text-dark-2 mb-1 h4 wallet_balance">00</h4>
                                <p class="mb-0 small text-dark-2">{{trans('lang.wallet_Balance')}}</p>
                            </div>
                            <span class="box-icon ab"><img src="{{ asset('images/wallet_icon_ic.png') }}"></span>
                        </div>
                    </div>
                </div>          
                ...
                <div class="col-12">
                    <div class="d-flex top-title-section pb-4 justify-content-between">
                        <div class="d-flex top-title-left align-self-center">
                            ...
                            <h3 class="mb-0">{{trans('lang.my_wallet_transactions')}}</h3>
                    ...
                    <div class="card border">
                        <div class="card-header d-flex justify-content-between align-items-center border-0">
                            <div class="card-header-title">
                                <h3 class="text-dark-2 mb-2 h4">{{trans('lang.my_wallet_transactions')}}</h3>
                                <p class="mb-0 text-dark-2">{{trans('lang.my_wallet_transaction_table_text')}}</p>
                            </div>
...
<script type="text/javascript">
    ...
    var ownerId = "{{$id}}"
    var ref=database.collection('wallet_transaction').where("userType","==",'owner').where('userId','==',ownerId).orderBy('createdDate','desc');
    var refOwner=database.collection('owner_users').where('id','==',ownerId);
    ...
    $(document).ready(function() {
        ...
        refOwner.get().then(async function (snapshot) {
            if (snapshot.empty) {
                jQuery("#overlay").hide();
                return;
            }           
            var ownerData = snapshot.docs[0].data();
            var walletAmount = ownerData.walletAmount ? ownerData.walletAmount : 0;          
            $(".wallet_balance").text(parseFloat(walletAmount || 0).toFixed(2));
        ...
        const table=$('#userTable').DataTable({
            ...
            ajax: async function(data,callback,settings) {
                ...
                const orderableColumns=['','id','','amount','note','createdDate','']; // Ensure this matches the actual column names
    ...
    async function buildHTML(val) {
        ...
        if(val.orderType!=null&&val.orderType!='') {
            ...
            html.push('<span class="action-btn"><a href="'+trroute1+'"><i class="mdi mdi-eye" aria-hidden="true"></i></a></span>');
        } else {
            html.push('');
