        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a
                        href="{!! route('intercity-service-rides') !!}">{{trans('lang.intercity_order_plural')}}</a>
                </li>
    ...
    <div class="container-fluid">
        <div class="card-body p-0 no_data_found">
                                        ...
                                        <div class="card service-details">
                                            ...
                                            <div class="card-body">
                                                <div class="address order_detail-top-box">
                                                    <p><strong>{{trans('lang.service_name')}}: </strong><span
                                                            id="service_name"></span></p>
                                                    ...
                                                    <div class="parcel-data">
                                                        ...
                                                        <p><strong>{{trans('lang.parcel_weight')}}: </strong><span
                                                                id="parcel_weight"></span></p>
                                                        <p><strong>{{trans('lang.parcel_image')}}: </strong><span
                                                                id="parcel_image"></span></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="order_addre-edit ">
                                            <div class="card-header bg-white d-flex align-items-center">
                                                ...
                                                <span class="badge badge-success ml-auto"
                                                    style="display: block;white-space: nowrap;">{{trans('lang.awarded')}}</span>
            ...
            <div class="form-group col-12 text-center btm-btn">
                <a href="{!! route('intercity-service-rides') !!}" class="btn btn-default"><i
        ...
        await refData.get().then(async function (snapshots) {
            if (snapshots.docs[0]) {
                ...
                if (orders.intercityService) {
                    ...
                    var serviceName='';
                    if(Array.isArray(orders.intercityService.name)) {
                        var foundItem=orders.intercityService.name.find(item => item.type===setLanguageCode);
                        if(foundItem&&foundItem.name!='') {
                            serviceName=foundItem.name;
                        } else {
                            var foundItem=orders.intercityService.name.find(item => item.type===defaultLanguageCode);
                            if(foundItem&&foundItem.name!='') {
                                serviceName=foundItem.name;
                            } else {
