    ...
    <script>
        ...
        async function getData(querySnapshot) {
            ...
            await Promise.all(querySnapshot.docs.map(async (doc) => {
                ...
                newUserObj['Email'] = shortEmail(userObj.email);
                if(userObj.countryCode.includes('+')){
                    userObj.countryCode = userObj.countryCode.slice(1);
                }
                else
                {
                    userObj.countryCode = userObj.countryCode;
                }

                var phoneNumber = shortReportNumber(userObj.countryCode , userObj.phoneNumber);
