...
<div class="page-wrapper">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor">{{trans('lang.owner_wallet_transactions')}}</h3>
        </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{url('/dashboard')}}">{{trans('lang.dashboard')}}</a></li>
                <li class="breadcrumb-item active">{{trans('lang.owner_wallet_transactions')}}</li>
            </ol>
        </div>
        <div>
        </div>
                ...
                <div class="col-12">
                    <div class="d-flex top-title-section pb-4 justify-content-between">
                        <div class="d-flex top-title-left align-self-center">
                            ...
                            <h3 class="mb-0">{{trans('lang.owner_wallet_transactions')}}</h3>
                    ...
                    <div class="card border">
                        <div class="card-header d-flex justify-content-between align-items-center border-0">
                            <div class="card-header-title">
                                <h3 class="text-dark-2 mb-2 h4">{{trans('lang.owner_wallet_transactions')}}</h3>
                                <p class="mb-0 text-dark-2">{{trans('lang.owner_wallet_transaction_table_text')}}</p>
                            </div>
...
<script type="text/javascript">
    ...
    var ref=database.collection('wallet_transaction').where("userType","==",'owner').orderBy('createdDate','desc');
        ...
        const table=$('#userTable').DataTable({
            ...
            ajax: async function(data,callback,settings) {
                ...
                ref.get().then(async function(querySnapshot) {
                    ...
                    let userNames={};
                    // Fetch driver names
                    const userDocs=await database.collection('owner_users').get();
