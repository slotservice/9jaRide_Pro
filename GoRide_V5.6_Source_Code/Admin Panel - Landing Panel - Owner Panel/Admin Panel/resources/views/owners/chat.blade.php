...
@section('scripts')
    ...
    <script>
        ...
        database.collection('owner_users').doc(id).get().then(async function(userSnapshot) {
        ...
        async function sendMessage() {
            ...
            chatDocRef.get().then(async (doc) => {
                ...
                if (!doc.exists) {
                    ...
                    const userDoc = await database.collection('owner_users').doc(id).get();
