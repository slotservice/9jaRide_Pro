    ...
    <div class="page-wrapper">
        <div class="row page-titles">
            ...
            <div class="col-md-5 align-self-center">
                <h3 class="text-themecolor restaurantTitle">{{ trans('lang.owner_details') }}</h3>
            </div>
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('/dashboard') }}">{{ trans('lang.dashboard') }}</a></li>
                    <li class="breadcrumb-item"><a href="{!! route('owners') !!}">{{ trans('lang.owner_plural') }}</a></li>
        ...
        <div class="container-fluid">
            <div class="row">
                                    ...
                                    <div class="card card-block p-card">
                                        <div class="profile-box">
                                            <div class="profile-card rounded">
                                                ...
                                                <a href="javascript:void(0)" data-toggle="modal" data-target="#changeSubscriptionModal" class="ml-3 mb-2 text-white change-plan btn btn-sm btn-success">{{ trans('lang.change_subscription_plan') }}</a>
                                            </div>
                                                ...
                                                <div class="table-responsive user-list-table active_subscription_div">
                                                    ...
                                                    <table class="table mb-0">
                                                        <tbody id="subscription-plan-detail">
                                                            ...
                                                            <tr>
                                                                <td class="py-2 px-0">
                                                                    <span class="font-weight-bold w-100">{{ trans('lang.total_booking_limit') }}:</span>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td class="py-2 px-0">
                                                                    <span class="font-weight-bold w-100">{{ trans('lang.total_driver_limit') }}:</span>
                                                                </td>
                                                                <td class="py-2 px-0 driver_limit"></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="py-2 px-0">
                                                                    <span class="font-weight-bold w-100">{{ trans('lang.available_driver_limit') }}:</span>
                                                                </td>
                                                                <td class="py-2 px-0 avail_driver_limit"></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="py-2 px-0">
                                    ...
                                    <div class="card card-block card-stretch">
                                        <div class="card-header bg-white">
                                            <ul class="nav nav-pills mb-3" role="tablist">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link driver_list" data-toggle="pill" href="#driver_list" role="tab">{{ trans('lang.driver_table') }}</a>
                                                </li>
                                                <li class="nav-item">
                                        ...
                                        <div class="card-body">
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane" id="driver_list" role="tabpanel">
                                                    <div class="table-responsive">
                                                        <table class="table table-striped table-valign-middle" id="driverListTable">
                                                            <thead class="table-color-heading">
                                                                <tr class="text-secondary">
                                                                    <th scope="col">{{ trans('lang.driver_id') }}</th>
                                                                    <th scope="col">{{ trans('lang.name') }}</th>
                                                                    <th scope="col">{{ trans('lang.email') }}</th>
                                                                    <th scope="col">{{ trans('lang.phone') }}</th>
                                                                    <th scope="col">{{ trans('lang.service_type') }}</th>
                                                                    <th scope="col">{{ trans('lang.actions') }}</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody id="driver_list_rows"></tbody>
                                                        </table>
                                                    </div>
                                                </div>
                                                        ...
                                                        <table class="table table-striped table-valign-middle" id="payoutRequestTable">
                                                            <thead class="table-color-heading">
                                                                <tr class="text-secondary">
                                                                    ...
                                                                    <th>{{ trans('lang.owners_payout_paid_date') }}</th>
                ...
                <div class="form-group col-12 text-center btm-btn doc-footer">
                    <a href="{!! route('owners') !!}" class="btn btn-default"><i class="fa fa-undo cancel-btn"></i>{{ trans('lang.cancel') }}</a>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary" id="add-wallet-btn">{{ trans('submit') }}</a></button>
                        ...
                        <div class="form-row">
                            <div class="form-group row">
                                ...
                                <div class="form-group row width-100">
                                    ...
                                    <div class="form-check width-100">
                                        <input type="radio" id="unlimited_driver" name="set_driver_limit" value="unlimited" checked>
                                        <label class="control-label" for="unlimited_driver">{{ trans('lang.unlimited') }}</label>
                                    </div>
                                    <div class="d-flex">
                                        <div class="form-check width-50 limited_driver_div">
                                            <input type="radio" id="limited_driver" name="set_driver_limit" value="limited">
                                            <label class="control-label" for="limited_driver">{{ trans('lang.limited') }}</label>
                                        </div>
                                        <div class="form-check width-50 d-none driver-limit-div">
                                            <input type="number" id="driver_limit" class="form-control" placeholder="{{ trans('lang.ex_1000') }}">
                                        </div>
                                    </div>
                                    <span class="driver_limit_err"></span>
                                </div>
...
@section('scripts')
    <script>
        ...
        var ref = database.collection('owner_users').doc(id);
        var rideRef = database.collection('orders').where("ownerId", "==", id).orderBy('createdDate', 'desc');
        var intercityRideRef = database.collection('orders_intercity').where("ownerId", "==", id).orderBy('createdDate', 'desc');
        var driversRef = database.collection('driver_users').where("ownerId", "==", id).orderBy('createdAt', 'desc');
        ...
        $(document).ready(async function() {
            if (requestUrl) {
                ...
                $(".owner-tab").first().addClass('active');
                $(".owner-tab").first().click();
            }
        ...
        ref.get().then(async function(snapshot) {
            ...
            if (data.hasOwnProperty('subscriptionExpiryDate') && data.hasOwnProperty('subscriptionPlanId') && data.subscriptionPlanId != '' && data.subscriptionPlanId != null) {
                ...
                $('.driver_limit').html((data.subscription_plan.driverLimit == '-1') ? "{{ trans('lang.unlimited') }}" : data.subscription_plan.driverLimit);
                $('.avail_booking_limit').html((data.subscriptionTotalOrders == '-1') ? "{{ trans('lang.unlimited') }}" : data.subscriptionTotalOrders);
                $('.avail_driver_limit').html((data.subscriptionTotalDrivers == '-1') ? "{{ trans('lang.unlimited') }}" : data.subscriptionTotalDrivers);
        ...
        $(document).on('click', '.driver_list', function() {
            getDriverList();
        });
        ...
        function getPayoutRequestListData(val) {
            ...
            var route1 = '{{ route('owners.view', ':id') }}';
        ...
        async function getRidesListData(data) {
            ...
            var customer = await getUser(data.userId);
            if (customer != '') {
            ...
            var driverName = await getUser(data.driverId,"driver");
            if (driverName != '') {
                html += '<td class="redirecttopage user_name_' + data.id + '"><a href="' + driver_view + '">' + driverName + '</a></td>';
            } else {
                html += '<td class="redirecttopage user_name_' + data.id + '">{{ trans('lang.unknown_user') }}</td>';
            }
        ...
        async function getUser(userId,type="user") {
            var collectionName = type == "driver" ? "driver_users" : "users";
            var userName = '';
            await database.collection(collectionName).where('id', '==', userId).get().then(async function(snapshots) {
                if (snapshots.docs.length > 0) {
                    var user = snapshots.docs[0].data();
        ...
        function getDriverList() {
            ...
            $("#driver_list_rows").html('');

            jQuery("#overlay").show();
            driversRef.get().then(async function(docSnapshot) {
                let html = '';

                html = await buildDriverListHtml(docSnapshot);
                if (html != '') {
                    $("#driver_list_rows").html(html);

                }
                var table = $('#driverListTable').DataTable();
                table.destroy();

                table = $('#driverListTable').DataTable({
                    order: [],
                    columnDefs: [{
                        orderable: false,
                        targets: [4, 5]
        ...
        async function buildDriverListHtml(snapshots) {
            var html = '';
            await Promise.all(snapshots.docs.map(async (listval) => {
                var val = listval.data();
                var getData = await getDriverListHtml(val);
                html += getData;
            }));
            return html;
        }

        async function getDriverListHtml(data) {

            var html = '';

            html += '<tr>';

            html += '<td><a href="/drivers/view/' + data.id + '" target="_blank">' + data.id.substring(0, 7) + '</a></td>';

            html += '<td>' + data.fullName + '</td>';

            html += '<td>' + data.email + '</td>';

            html += '<td>' + data.countryCode +' '+ data.phoneNumber+'</td>';
            ...
            html += '<td><a id="' + data.id + '" name="driver-delete" class="delete-btn" href="javascript:void(0)"><i class="mdi mdi-delete"></i></a></td>';
        ...
        $("#add-wallet-btn").click(function() {
            ...
            database.collection('owner_users').where('id', '==', id).get().then(async function(snapshot) {
                ...
                if (snapshot.docs.length > 0) {
                    ...
                    database.collection('owner_users').doc(id).update({
        ...
        $('#driver_id').on('change', async function () {
            
            $('.show_ac_non_ac_div').empty().addClass('d-none');
            $('.show_km_charges_div').empty().addClass('d-none');
            
            const $opt = $(this).find('option:selected');
            const driverId = $opt.val();
            if (!driverId) return;

            const zoneIds = JSON.parse($opt.attr('data-zone-ids') || '[]');
            const serviceId = $opt.attr('data-service-id');
            if (!serviceId || zoneIds.length === 0) return;

            // fetch service doc
            const sdoc = await database.collection('service').doc(serviceId).get();
            if (!sdoc.exists) return;
            const service = sdoc.data();
            const isAcNonAc = (service.isAcNonAc === true || service.isAcNonAc === "true");
            ...
            if (isAcNonAc) {
                ...
                let $row = $('<div class="row"></div>');
                 for (const zid of zoneIds) {
                    const zdoc = await database.collection('zone').doc(zid).get();
                    const zoneName = zdoc.data().name;
                    let zoneNameData = zoneName.find(item => item.type === setLanguageCode);
                    $row.append(`
                        <div class="row" data-zone="${zid}">
                          <div class="col-md-6">
                            <label class="control-label">
                                {{ trans('lang.ac_charges') }} {{ trans('lang.per') }} ${distanceType} {{ trans('lang.rate') }} (${zoneNameData.name}) <span class="required-field"></span>
                            </label>
                            <div class="control-input-box">
                                <input type="number" class="form-control ac_charges" data-zone="${zid}" min="0">
                            </div>
                          </div> 
                          <div class="col-md-6">
                            <label class="control-label">
                                {{ trans('lang.nonac_charges') }} {{ trans('lang.per') }} ${distanceType} {{ trans('lang.rate') }} (${zoneNameData.name}) <span class="required-field"></span>
                            </label>
                            <div class="control-input-box">
                                <input type="number" class="form-control nonac_charges" data-zone="${zid}" min="0">
                            </div>
                          </div>                         
                        </div>                      
                    `);
                }
                $('.show_ac_non_ac_div').append($row);
            } else {
                $('.show_km_charges_div').removeClass('d-none');
                let $row = $('<div class="row"></div>');
                for (const zid of zoneIds) {
                    const zdoc = await database.collection('zone').doc(zid).get();
                    const zoneName = zdoc.data().name;
                    ...
                    $row.append(`
                        <div class="col-md-6">
                            <label class="control-label">
                                {{ trans('lang.per') }} ${distanceType} {{ trans('lang.rate') }} (${zoneNameData.name})
                                <span class="required-field"></span>
                            </label>
                            <div class="control-input-box">
                                <input type="number" class="form-control km_charges" data-zone="${zid}" min="0">
                ...
                $('.show_km_charges_div').append($row);
            }
        });
        ...
        async function getSubscriptionPlan() {
            ...
            database.collection('subscription_plans').where('isEnable', '==', true).where('planFor', 'in', ['both', 'owner']).get().then(async function(snapshots) {
                let plans = [];
        ...
        $('.update-plan-limit').click(async function() {
            ...
            var driver_limit = (set_driver_limit == 'limited') ? $('#driver_limit').val() : '-1';

            if (set_booking_limit == 'limited' && $('#booking_limit').val() == '') {
                $(".booking_limit_err").html("<p>{{ trans('lang.enter_booking_limit') }}</p>");
                return false;
            }else if(set_driver_limit == 'limited' && $('#driver_limit').val() == ''){
                $(".driver_limit_err").html("<p>{{ trans('lang.enter_driver_limit') }}</p>");
                return false;
            } else {
                await database.collection('owner_users').doc(id).update({
                    'subscription_plan.bookingLimit': booking_limit,
                    'subscription_plan.driverLimit': driver_limit,
                    'subscriptionTotalOrders': booking_limit,
                    'subscriptionTotalDrivers': driver_limit,
                }).then(async function(result) {
                    window.location.reload();
                });
            }
