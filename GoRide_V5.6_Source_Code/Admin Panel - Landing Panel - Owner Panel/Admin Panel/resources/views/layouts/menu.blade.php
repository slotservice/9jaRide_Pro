...
<nav class="sidebar-nav">
    ...
    <ul id="sidebarnav">
        ...
        @if(in_array('god-eye', $role_has_permission) || in_array('zone', $role_has_permission) || in_array('surgzone', $role_has_permission))
        ...
        @if(in_array('surgezone', $role_has_permission))

            <li>
                <a class="waves-effect waves-dark" href="{!! url('surge-zone') !!}" aria-expanded="false">

                    <i class="mdi mdi-map-marker-radius"></i>

                    <span class="hide-menu">{{trans('lang.surge_zone')}}</span>
        ...
        @if(in_array('fleet_drivers', $role_has_permission))
            <li>
                <a class="waves-effect waves-dark user_menu" href="{!! route('fleet.driver.list') !!}" aria-expanded="false">
        ...
        @if(in_array('owners', $role_has_permission) || in_array('approve_owners', $role_has_permission) ||
                ...
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse">
                        @if(in_array('owners', $role_has_permission))
                            <li class="all_owner_menu"><a href="{!! url('owners') !!}">{{trans('lang.all_owners')}}</a></li>
                        @endif
                        @if(in_array('approve_owners', $role_has_permission))
                            <li class="approve_owner_menu"><a
                                    href="{!! url('owners/approved') !!}">{{trans('lang.approved_owners')}}</a></li>
                        @endif
                        @if(in_array('pending_owners', $role_has_permission))
                            <li class="pending_driver_menu"><a
                                    href="{!! url('owners/pending') !!}">{{trans('lang.approval_pending_owners')}}</a></li>
                        @endif
                    </ul>
                </li>
        @endif
        ...
        @endif
        <li>
            <a class="has-arrow waves-effect waves-dark subscription_menu" href="#" aria-expanded="false">
                <i class="mdi mdi mdi-credit-card"></i>
                <span class="hide-menu">{{trans('lang.subscription_plans')}}</span>
            </a>
            <ul aria-expanded="false" class="collapse subscription_sub_menu">
                @if(in_array('subscription-plans', $role_has_permission))
                    <li class="subscription_plans_menu"><a
                            href="{!! url('subscription-plans') !!}">{{trans('lang.subscription_plans')}}</a></li>
                @endif
                @if(in_array('subscription-history', $role_has_permission))
                    <li class="subscription_history_menu"><a
                            href="{!! route('driver.subscriptionHistory') !!}">{{trans('lang.subscription_history')}}</a>
                    </li>
                @endif
            </ul>
        </li>
        ...
        @if(in_array('cms', $role_has_permission) || in_array('banners', $role_has_permission)
            ...
            ||in_array('supportHistory', $role_has_permission))
        ...
        @endif
         @if(in_array('supportHistory', $role_has_permission))
            <li><a class="waves-effect waves-dark sos_menu" href="{!! url('support') !!}" aria-expanded="false">
        ...
        @if(in_array('payout-request', $role_has_permission) ||
            ...
            in_array('owners-wallet-transaction', $role_has_permission))
                ...
                <li>
                    ...
                    @endif
                    @if(in_array('owners-wallet-transaction', $role_has_permission))
                        <ul aria-expanded="false" class="collapse">
                            <li><a href="{!! route('walletTransaction.owner') !!}">{{trans('lang.owner_wallet_transactions')}}</a>
                            </li>
                        </ul>
                    @endif
        ...
        @if(in_array('global-setting', $role_has_permission) || in_array('admin-commission', $role_has_permission) ||
            ...
            || in_array('privacy', $role_has_permission) || in_array('terms', $role_has_permission) || in_array('schedule-notification', $role_has_permission))
                ...
                <li>
                    ...
                    <ul aria-expanded="false" class="collapse setting_sub_menu">
                        ...
                        @endif
                        @if(in_array('maintenance-setting', $role_has_permission))
                        <li><a href="{!! url('settings/maintenance') !!}">{{trans('lang.maintenance_setting')}}</a></li>
                        @endif

                        @if(in_array('admin-commission', $role_has_permission))
                            <li><a href="{!! url('settings/businessModel') !!}">{{trans('lang.business_model_settings')}}</a></li>
                        @endif
                        @if(in_array('schedule-notification', $role_has_permission))
                            <li><a
                                    href="{!! url('settings/scheduleNotification') !!}">{{trans('lang.schedule_notification_setting')}}</a>
                            </li>
                        @endif
