<div class="navbar-header">
    ...
    <a class="navbar-brand" href="<?php echo URL::to('/'); ?>">
        ...
        <b>
            ...
            <img src="{{ asset('images/9jaride-pro-logo.png?v=2') }}" onerror="this.onerror=null; this.src='{{ asset('images/9jaride-pro-logo.png?v=2') }}';" alt="homepage" class="dark-logo" width="100%"

                 id="logo_web"> 

            <img src="{{ asset('images/9jaride-pro-logo.png?v=2') }}" onerror="this.onerror=null; this.src='{{ asset('images/9jaride-pro-logo.png?v=2') }}';"  alt="homepage" class="light-logo">
