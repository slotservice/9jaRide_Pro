                ...
                <div class="col-12">
                    <div class="d-flex top-title-section pb-4 justify-content-between">
                        <div class="d-flex top-title-left align-self-center">
                            ...
                            <h3 class="mb-0">{{trans('lang.faq_plural')}}</h3>
                ...
                <div class="card border">
                     <div class="card-header d-flex justify-content-between align-items-center border-0">
                        <div class="card-header-title">
                            <h3 class="text-dark-2 mb-2 h4">{{trans('lang.faq_plural')}}</h3>
                            <p class="mb-0 text-dark-2">{{trans('lang.faq_table_text')}}</p>
                        </div>
                        <div class="card-header-right d-flex align-items-center">
                            <div class="card-header-btn mr-3">
                                <a class="btn-primary btn rounded-full" href="{!! url('/faq/save') !!}"><i
                                        class="mdi mdi-plus mr-2"></i>{{trans('lang.faq_create')}}</a>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <th class="delete-all"><input type="checkbox" id="is_active"><label
                                                    class="col-3 control-label" for="is_active"><a id="deleteAll"
                                                        class="do_not_delete" href="javascript:void(0)"><i
                                                            class="mdi mdi-delete"></i> </a></label></th>
...
<script type="text/javascript">
    ...
    function getListData(val) {
        ...
        if(checkDeletePermission) {
            ...
            html=html+'<a id="'+val.id+'" class="delete-btn" name="faq-delete" href="javascript:void(0)"><i class="mdi mdi-delete"></i></a>';
        }
        html=html+'</td>';
        html=html+'</tr>';
