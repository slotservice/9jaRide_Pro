                                ...
                                <ul class="nav nav-tabs">
                                    ...
                                    <li role="presentation" class="">
                                        ...
                                        <a href="#user" aria-controls="information" role="tab" data-toggle="tab"
                                           ...
                                           class="{{ (Request::get('tab') == 'user' || Request::get('tab') == '') ? 'active show' : '' }}">{{trans('lang.dashboard_user')}}</a>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-group">
                                                    ...
                                                    <div class="text-right">
                                                        ...
                                                        <button type="submit" class="btn btn-primary edit-form-btn"><i
...
<script type="text/javascript">
    ...
    var locations = [
        ...
        function initialize() {
            ...
            if(mapType == "OSM"){
                // OpenStreetMap Initialization using Leaflet
                map = L.map('map').setView([lat, lng], 6);  // Set initial view for OSM
                ...
                // Routing (OSM Directions plugin can be used here)
                // Example using leaflet-routing-machine (you will need to include this plugin for routing)
                L.Routing.control({
                    waypoints: [
