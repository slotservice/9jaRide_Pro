...
@section('scripts')
    ...
    <script>
        ...
        $(document).ready(async function () {
            ...
            var globalSettingsRef = await database.collection('settings').doc('globalValue').get();
            var globalSettings = globalSettingsRef.data();
            var defaultCountryCode = globalSettings.defaultCountryCode || "";
            ...
            ref.get().then(async function (snapshots) {
                ...
                if(data.country){
                    ...
                    var $option = $(".tax_country option").filter(function(){
                        return $(this).data("code") == defaultCountryCode.toUpperCase();
                    });
                    if ($option.length) {
                        $(".tax_country").val($option.val());
                    }
                }
