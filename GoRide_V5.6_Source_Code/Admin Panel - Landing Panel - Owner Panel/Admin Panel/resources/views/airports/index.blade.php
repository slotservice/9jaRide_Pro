                ...
                <div class="col-12">
                    <div class="d-flex top-title-section pb-4 justify-content-between">
                        <div class="d-flex top-title-left align-self-center">
                            <span class="icon mr-3"><img src="{{ asset('images/airport.png') }}"></span>
                            <h3 class="mb-0">{{trans('lang.airports_table')}}</h3>
                    ...
                    <div class="card border">
                        <div class="card-header d-flex justify-content-between align-items-center border-0">
                            <div class="card-header-title">
                                <h3 class="text-dark-2 mb-2 h4">{{trans('lang.airports_table')}}</h3>
                                <p class="mb-0 text-dark-2">{{trans('lang.airports_table_text')}}</p>
                            </div>
                            <div class="card-header-right d-flex align-items-center">
                                <div class="card-header-btn mr-3">
                                    <a class="btn-primary btn rounded-full" href="{{route('airport.save')}}"><i
                                            class="mdi mdi-plus mr-2"></i>{{trans('lang.airport_add')}}</a>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    async function getListData(val) {
        ...
        html=html+'<td class="action-btn"><a href="'+route1+'" name="airport-edit"><i class="mdi mdi-lead-pencil"></i></a>';
        if(checkDeletePermission) {

            html=html+'<a id="'+val.id+'" class="delete-btn" name="airport-delete" href="javascript:void(0)"><i class="mdi mdi-delete"></i></a>';
        }
        html=html+'</td>';
        html=html+'</tr>';
        return html;
