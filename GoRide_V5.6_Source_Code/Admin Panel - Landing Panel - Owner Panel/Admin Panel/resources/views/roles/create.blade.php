                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" id="fleet-drivers-list" value="fleet.driver.list" name="fleet_drivers[]" class="permission">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            {{-- <input type="checkbox" id="approve-drivers-edit"
                                                            value="approve.driver.edit" name="approve_drivers[]"
                                                            class="permission">
                                                        <label class="control-label2"
                                                            for="approve-drivers-edit">{{trans('lang.edit')}}</label>

                                                        <input type="checkbox" id="approve-drivers-view"
                                                            value="approve.driver.view" name="approve_drivers[]"
                                                            class="permission">
                                                        <label class="control-label2"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            {{-- <input type="checkbox" id="pending-drivers-edit"
                                                            value="pending.driver.edit" name="pending_drivers[]"
                                                            class="permission">
                                                        <label class=" control-label2"
                                                            for="pending-drivers-edit">{{trans('lang.edit')}}</label>

                                                        <input type="checkbox" id="pending-drivers-view"
                                                            value="pending.driver.view" name="pending_drivers[]"
                                                            class="permission">
                                                        <label class=" control-label2"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="checkbox" id="owners-chat" value="owners.chat" name="owners[]" class="permission">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="checkbox" id="ride-order-delete" value="order.delete" name="ride_order[]" class="permission">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="checkbox" id="intercity-order-delete" value="intercity.order.delete" name="intercity_order[]" class="permission">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" id="owners-wallet-transactions" value="owner.wallet.list" name="owners-wallet-transaction[]" class="permission">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" id="maintenance-setting" value="maintenance-setting" name="maintenance-setting[]" class="permission">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" id="schedule-notification" value="schedule-notification" name="schedule-notification[]" class="permission">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" id="surgezone-list" value="surgezone.list" name="surgezone[]" class="permission">
                                                            <label class=" control-label2" for="surgezone-list">{{ trans('lang.list') }}</label>
                                                            <input type="checkbox" id="surgezone-edit" value="surgezone.edit" name="surgezone[]" class="permission">
                                                            <label class=" control-label2" for="surgezone-edit">{{ trans('lang.edit') }}</label>
                                                            <input type="checkbox" id="surgezone-delete" value="surgezone.delete" name="surgezone[]" class="permission">
