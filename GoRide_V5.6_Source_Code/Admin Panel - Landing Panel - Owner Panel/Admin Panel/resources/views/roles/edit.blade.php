                                        ...
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="role-list" value="roles.list" name="roles[]" class="permission" {{ in_array('roles.list', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="role-list">{{ trans('lang.list') }}</label>

                                                        <input type="checkbox" id="role-save" value="roles.create" name="roles[]" class="permission" {{ in_array('roles.create', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="role-save">{{ trans('lang.create') }}</label>

                                                        <input type="checkbox" id="role-store" value="roles.store" name="roles[]" class="permission" {{ in_array('roles.store', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="role-store">{{ trans('lang.store') }}</label>

                                                        <input type="checkbox" id="role-edit" value="roles.edit" name="roles[]" class="permission" {{ in_array('roles.edit', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="role-edit">{{ trans('lang.edit') }}</label>

                                                        <input type="checkbox" id="role-update" value="roles.update" name="roles[]" class="permission" {{ in_array('roles.update', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="role-update">{{ trans('lang.update') }}</label>

                                                        <input type="checkbox" id="role-delete" value="roles.delete" name="roles[]" class="permission" {{ in_array('roles.delete', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="admin-list" value="admin.list" name="admins[]" class="permission" {{ in_array('admin.list', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="admin-list">{{ trans('lang.list') }}</label>

                                                        <input type="checkbox" id="admin-create" value="admin.create" name="admins[]" class="permission" {{ in_array('admin.create', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="admin-create">{{ trans('lang.create') }}</label>

                                                        <input type="checkbox" id="admin-store" value="admin.store" name="admins[]" class="permission" {{ in_array('admin.store', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="admin-store">{{ trans('lang.store') }}</label>

                                                        <input type="checkbox" id="admin-edit" value="admin.edit" name="admins[]" class="permission" {{ in_array('admin.edit', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="admin-edit">{{ trans('lang.edit') }}</label>

                                                        <input type="checkbox" id="admin-update" value="admin.update" name="admins[]" class="permission" {{ in_array('admin.update', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="admin-update">{{ trans('lang.update') }}</label>

                                                        <input type="checkbox" id="admin-delete" value="admin.delete" name="admins[]" class="permission" {{ in_array('admin.delete', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="user-list" value="user.list" name="users[]" class="permission" {{ in_array('user.list', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="user-list">{{ trans('lang.list') }}</label>

                                                        <input type="checkbox" id="user-edit" value="user.edit" name="users[]" class="permission" {{ in_array('user.edit', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="user-edit">{{ trans('lang.edit') }}</label>

                                                        <input type="checkbox" id="user-view" value="user.view" name="users[]" class="permission" {{ in_array('user.view', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="user-view">{{ trans('lang.view') }}</label>

                                                        <input type="checkbox" id="user-delete" value="user.delete" name="users[]" class="permission" {{ in_array('user.delete', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="drivers-list" value="driver.list" name="drivers[]" class="permission" {{ in_array('driver.list', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="drivers-list">{{ trans('lang.list') }}</label>

                                                        <input type="checkbox" id="drivers-edit" value="driver.edit" name="drivers[]" class="permission" {{ in_array('driver.edit', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="drivers-edit">{{ trans('lang.edit') }}</label>

                                                        <input type="checkbox" id="drivers-view" value="driver.view" name="drivers[]" class="permission" {{ in_array('driver.view', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="drivers-view">{{ trans('lang.view') }}</label>

                                                        <input type="checkbox" id="drivers-delete" value="driver.delete" name="drivers[]" class="permission" {{ in_array('driver.delete', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="fleet-drivers-list" value="fleet.driver.list" name="fleet_drivers[]" class="permission" {{ in_array('fleet.driver.list', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="fleet-drivers-list">{{ trans('lang.list') }}</label>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="approve-drivers-list" value="approve.driver.list" name="approve_drivers[]" class="permission" {{ in_array('approve.driver.list', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="approve-drivers-list">{{ trans('lang.list') }}</label>

                                                        <input type="checkbox" id="approve-drivers-delete" value="approve.driver.delete" name="approve_drivers[]" class="permission" {{ in_array('approve.driver.delete', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="pending-drivers-list" value="pending.driver.list" name="pending_drivers[]" class="permission" {{ in_array('pending.driver.list', $permissions) ? 'checked' : '' }}>
                                                        <label class="control-label2" for="pending-drivers-list">{{ trans('lang.list') }}</label>

                                                        <input type="checkbox" id="pending-drivers-delete" value="pending.driver.delete" name="pending_drivers[]" class="permission" {{ in_array('pending.driver.delete', $permissions) ? 'checked' : '' }}>
                                                 ...
                                                 <tr>
                                                    <td>
                                                        <strong>{{ trans('lang.all_owner_plural') }}</strong>
                                                    </td>
                                                    <td>
                                                        ...
                                                        <input type="checkbox" id="owners-chat" value="owners.chat" name="owners[]" class="permission" {{ in_array('owners.chat', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="owners-chat">{{ trans('lang.chat') }}</label>
                                                ...
                                                <tr>
                                                    <td>
                                                        <strong>{{ trans('lang.approve_owner_plural') }}</strong>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <strong>{{ trans('lang.pending_owner_plural') }}</strong>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="documents-list" value="document.list" name="documents[]" class="permission" {{ in_array('document.list', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="documents-list">{{ trans('lang.list') }}</label>

                                                        <input type="checkbox" id="documents-create" value="document.create" name="documents[]" class="permission" {{ in_array('document.create', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="documents-create">{{ trans('lang.create') }}</label>

                                                        <input type="checkbox" id="documents-edit" value="document.edit" name="documents[]" class="permission" {{ in_array('document.edit', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="documents-edit">{{ trans('lang.edit') }}</label>

                                                        <input type="checkbox" id="documents-delete" value="document.delete" name="documents[]" class="permission" {{ in_array('document.delete', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="deleted-documents-list" value="document.deleted" name="deleted-documents[]" class="permission" {{ in_array('document.deleted', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="user-report" value="user.report" name="reports[]" class="permission" {{ in_array('user.report', $permissions) ? 'checked' : '' }}>
                                                        <label class="control-label2" for="user-report">{{ trans('lang.user') }}</label>

                                                        <input type="checkbox" id="driver-report" value="driver.report" name="reports[]" class="permission" {{ in_array('driver.report', $permissions) ? 'checked' : '' }}>
                                                        <label class="control-label2" for="driver-report">{{ trans('lang.driver') }}</label>

                                                        <input type="checkbox" id="ride-report" value="ride.report" name="reports[]" class="permission" {{ in_array('ride.report', $permissions) ? 'checked' : '' }}>
                                                        <label class="control-label2" for="ride-report">{{ trans('lang.ride') }}</label>

                                                        <input type="checkbox" id="intercity-report" value="intercity.report" name="reports[]" class="permission" {{ in_array('intercity.report', $permissions) ? 'checked' : '' }}>
                                                        <label class="control-label2" for="intercity-report">{{ trans('lang.intercity') }}</label>

                                                        <input type="checkbox" id="transaction-report" value="transaction.report" name="reports[]" class="permission" {{ in_array('transaction.report', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    <td>
                                                        <strong>{{ trans('lang.subscription_history_plural') }}</strong>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="service-list" value="service.list" name="service[]" class="permission" {{ in_array('service.list', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="service-list">{{ trans('lang.list') }}</label>

                                                        <input type="checkbox" id="service-create" value="service.create" name="service[]" class="permission" {{ in_array('service.create', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="service-create">{{ trans('lang.create') }}</label>

                                                        <input type="checkbox" id="service-edit" value="service.edit" name="service[]" class="permission" {{ in_array('service.edit', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="service-edit">{{ trans('lang.edit') }}</label>

                                                        <input type="checkbox" id="service-delete" value="service.delete" name="service[]" class="permission" {{ in_array('service.delete', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="ride-order-list" value="order.list" name="ride_order[]" class="permission" {{ in_array('order.list', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="ride-order-list">{{ trans('lang.list') }}</label>

                                                        <input type="checkbox" id="ride-order-view" value="order.view" name="ride_order[]" class="permission" {{ in_array('order.view', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="ride-order-view">{{ trans('lang.view') }}</label>

                                                        <input type="checkbox" id="ride-order-delete" value="order.delete" name="ride_order[]" class="permission" {{ in_array('order.delete', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="ride-order-delete">{{ trans('lang.delete') }}</label>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="intercity-list" value="intercity.service.list" name="intercity_service[]" class="permission" {{ in_array('intercity.service.list', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="intercity-list">{{ trans('lang.list') }}</label>

                                                        <input type="checkbox" id="intercity-edit" value="intercity.service.edit" name="intercity_service[]" class="permission" {{ in_array('intercity.service.edit', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="intercity-order-list" value="intercity.order.list" name="intercity_order[]" class="permission" {{ in_array('intercity.order.list', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="intercity-order-list">{{ trans('lang.list') }}</label>

                                                        <input type="checkbox" id="intercity-order-view" value="intercity.order.view" name="intercity_order[]" class="permission" {{ in_array('intercity.order.view', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="intercity-order-view">{{ trans('lang.view') }}</label>

                                                        <input type="checkbox" id="intercity-order-delete" value="intercity.order.delete" name="intercity_order[]" class="permission" {{ in_array('intercity.order.delete', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="intercity-order-delete">{{ trans('lang.delete') }}</label>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="freight-list" value="freight.list" name="freight[]" class="permission" {{ in_array('freight.list', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="freight-list">{{ trans('lang.list') }}</label>

                                                        <input type="checkbox" id="freight-create" value="freight.create" name="freight[]" class="permission" {{ in_array('freight.create', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="freight-create">{{ trans('lang.create') }}</label>

                                                        <input type="checkbox" id="freight-edit" value="freight.edit" name="freight[]" class="permission" {{ in_array('freight.edit', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="freight-edit">{{ trans('lang.edit') }}</label>

                                                        <input type="checkbox" id="freight-delete" value="freight.delete" name="freight[]" class="permission" {{ in_array('freight.delete', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="airports-list" value="airports.list" name="airports[]" class="permission" {{ in_array('airports.list', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="airports-list">{{ trans('lang.list') }}</label>

                                                        <input type="checkbox" id="airports-create" value="airports.create" name="airports[]" class="permission" {{ in_array('airports.create', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="airports-create">{{ trans('lang.create') }}</label>

                                                        <input type="checkbox" id="airports-edit" value="airports.edit" name="airports[]" class="permission" {{ in_array('airports.edit', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="airports-edit">{{ trans('lang.edit') }}</label>

                                                        <input type="checkbox" id="airports-delete" value="airports.delete" name="airports[]" class="permission" {{ in_array('airports.delete', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="vehicle-type-list" value="vehicle.type.list" name="vehicle-type[]" class="permission" {{ in_array('vehicle.type.list', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="vehicle-type-list">{{ trans('lang.list') }}</label>

                                                        <input type="checkbox" id="vehicle-type-create" value="vehicle.type.create" name="vehicle-type[]" class="permission" {{ in_array('vehicle.type.create', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="vehicle-type-create">{{ trans('lang.create') }}</label>

                                                        <input type="checkbox" id="vehicle-type-edit" value="vehicle.type.edit" name="vehicle-type[]" class="permission" {{ in_array('vehicle.type.edit', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="vehicle-type-edit">{{ trans('lang.edit') }}</label>

                                                        <input type="checkbox" id="vehicle-type-delete" value="vehicle.type.delete" name="vehicle-type[]" class="permission" {{ in_array('vehicle.type.delete', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="driver-rules-list" value="rule.list" name="driver-rules[]" class="permission" {{ in_array('rule.list', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="driver-rules-list">{{ trans('lang.list') }}</label>

                                                        <input type="checkbox" id="driver-rules-create" value="rule.create" name="driver-rules[]" class="permission" {{ in_array('rule.create', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="driver-rules-create">{{ trans('lang.create') }}</label>

                                                        <input type="checkbox" id="driver-rules-edit" value="rule.edit" name="driver-rules[]" class="permission" {{ in_array('rule.edit', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="driver-rules-edit">{{ trans('lang.edit') }}</label>

                                                        <input type="checkbox" id="driver-rules-delete" value="rule.delete" name="driver-rules[]" class="permission" {{ in_array('rule.delete', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="deleted-driver-rules-list" value="rule.delete.list" name="deleted-driver-rules[]" class="permission" {{ in_array('rule.delete.list', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="cms" value="cms.list" name="cms[]" class="permission" {{ in_array('cms.list', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="banners" value="banners.list" name="banners[]" class="permission" {{ in_array('banners.list', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="deleted-banner" value="banner.delete.list" name="deleted-banner[]" class="permission" {{ in_array('banner.delete.list', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="on-board-list" value="onboard.list" name="on-board[]" class="permission" {{ in_array('onboard.list', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="on-board-list">{{ trans('lang.list') }}</label>

                                                        <input type="checkbox" id="on-board-edit" value="onboard.edit" name="on-board[]" class="permission" {{ in_array('onboard.edit', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="faq-list" value="faq.list" name="faq[]" class="permission" {{ in_array('faq.list', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="faq-list">{{ trans('lang.list') }}</label>
                                                        <input type="checkbox" id="faq-create" value="faq.create" name="faq[]" class="permission" {{ in_array('faq.create', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="faq-create">{{ trans('lang.create') }}</label>
                                                        <input type="checkbox" id="faq-edit" value="faq.edit" name="faq[]" class="permission" {{ in_array('faq.edit', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="faq-edit">{{ trans('lang.edit') }}</label>

                                                        <input type="checkbox" id="faq-delete" value="faq.delete" name="faq[]" class="permission" {{ in_array('faq.delete', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="sos-list" value="sos.list" name="sos[]" class="permission" {{ in_array('sos.list', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="sos-list">{{ trans('lang.list') }}</label>

                                                        <input type="checkbox" id="sos-edit" value="sos.edit" name="sos[]" class="permission" {{ in_array('sos.edit', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="sos-edit">{{ trans('lang.edit') }}</label>

                                                        <input type="checkbox" id="sos-delete" value="sos.delete" name="sos[]" class="permission" {{ in_array('sos.delete', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="tax-list" value="tax.list" name="tax[]" class="permission" {{ in_array('tax.list', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="coupon-list" value="coupon.list" name="coupon[]" class="permission" {{ in_array('coupon.list', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="coupon-list">{{ trans('lang.list') }}</label>
                                                        <input type="checkbox" id="coupon-create" value="coupon.create" name="coupon[]" class="permission" {{ in_array('coupon.create', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="coupon-create">{{ trans('lang.create') }}</label>
                                                        <input type="checkbox" id="coupon-edit" value="coupon.edit" name="coupon[]" class="permission" {{ in_array('coupon.edit', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="coupon-edit">{{ trans('lang.edit') }}</label>

                                                        <input type="checkbox" id="coupon-delete" value="coupon.delete" name="coupon[]" class="permission" {{ in_array('coupon.delete', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="deleted-coupon-list" value="coupon.delete.list" name="deleted-coupon[]" class="permission" {{ in_array('coupon.delete.list', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="currency-list" value="currency.list" name="currency[]" class="permission" {{ in_array('currency.list', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="currency-list">{{ trans('lang.list') }}</label>
                                                        <input type="checkbox" id="currency-create" value="currency.create" name="currency[]" class="permission" {{ in_array('currency.create', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="currency-create">{{ trans('lang.create') }}</label>

                                                        <input type="checkbox" id="currency-edit" value="currency.edit" name="currency[]" class="permission" {{ in_array('currency.edit', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="language-list" value="language.list" name="language[]" class="permission" {{ in_array('language.list', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="deleted-language" value="language.delete.list" name="deleted-language[]" class="permission" {{ in_array('language.delete.list', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="payout-request-list" value="payout-request" name="payout-request[]" class="permission" {{ in_array('payout-request', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    <td>
                                                        <strong>{{ trans('lang.owner_wallet_transactions') }}</strong>
                                                    </td>
                                                    <td>
                                                        <input type="checkbox" id="owners-wallet-transactions" value="owner.wallet.list" name="owners-wallet-transaction[]" class="permission" {{ in_array('owner.wallet.list', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="owners-wallet-transactions">{{ trans('lang.list') }}</label>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="drivers-wallet-transactions" value="driver.wallet.list" name="drivers-wallet-transaction[]" class="permission" {{ in_array('driver.wallet.list', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="users-wallet-transactions" value="user.wallet.list" name="users-wallet-transaction[]" class="permission" {{ in_array('user.wallet.list', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="global-setting" value="global-setting" name="global-setting[]" class="permission" {{ in_array('global-setting', $permissions) ? 'checked' : '' }}>
                                                 ...
                                                 <tr>
                                                    <td>
                                                        <strong>{{ trans('lang.app_setting_maintenance') }}</strong>
                                                    </td>
                                                    <td>
                                                        <input type="checkbox" id="maintenance-setting" value="maintenance-setting" name="maintenance-setting[]" class="permission" {{ in_array('maintenance-setting', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="maintenance-setting">{{ trans('lang.update') }}</label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="admin-commission" value="admin-commision" name="admin-commission[]" class="permission" {{ in_array('admin-commision', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    <td>
                                                        <strong>{{ trans('lang.schedule_notification_setting') }}</strong>
                                                    </td>
                                                    <td>
                                                        <input type="checkbox" id="schedule-notification" value="schedule-notification" name="schedule-notification[]" {{ in_array('schedule-notification', $permissions) ? 'checked' : '' }}>
                                                        <label class=" control-label2" for="schedule-notification">{{ trans('lang.update') }}</label>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="homepageTemplate" value="home-page" name="homepageTemplate[]" class="permission" {{ in_array('home-page', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="header-template" value="header" name="header-template[]" class="permission" {{ in_array('header', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="footer-template" value="footer" name="footer-template[]" class="permission" {{ in_array('footer', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="privacy" value="privacy" name="privacy[]" class="permission" {{ in_array('privacy', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="checkbox" id="terms" value="terms" name="terms[]" class="permission" {{ in_array('terms', $permissions) ? 'checked' : '' }}>
                                                ...
                                                <tr>
                                                 ...
                                                 <tr>
                                                        <td>
                                                            <strong>{{ trans('lang.surge_zone') }}</strong>
                                                        </td>
                                                        <td>
                                                            <input type="checkbox" id="surgezone-list" value="surgezone.list" name="surgezone[]" class="permission" {{ in_array('surgezone.list', $permissions) ? 'checked' : '' }}>
                                                            <label class=" control-label2" for="surgezone-list">{{ trans('lang.list') }}</label>
                                                            <input type="checkbox" id="surgezone-edit" value="surgezone.edit" name="surgezone[]" class="permission" {{ in_array('surgezone.edit', $permissions) ? 'checked' : '' }}>
                                                            <label class=" control-label2" for="surgezone-edit">{{ trans('lang.edit') }}</label>
                                                            <input type="checkbox" id="surgezone-delete" value="surgezone.delete" name="surgezone[]" class="permission" {{ in_array('surgezone.delete', $permissions) ? 'checked' : '' }}>
                                                            <label class=" control-label2" for="surgezone-delete">{{ trans('lang.delete') }}</label>
                                                        </td>
                                                    </tr>
