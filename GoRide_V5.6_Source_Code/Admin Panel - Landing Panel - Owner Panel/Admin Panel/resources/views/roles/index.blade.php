                 ...
                 <div class="card-header d-flex justify-content-between align-items-center border-0">
                   ...
                   <div class="card-header-right d-flex align-items-center">
                        <div class="card-header-btn mr-3"> 
                            <a class="btn-primary btn rounded-full" href="{!! route('role.create') !!}"><i class="mdi mdi-plus mr-2"></i>{{trans('lang.create_role')}}</a>
                        </div>
                    </div>
                 </div>
                 <div class="card-body">
                                    ...
                                    <tr>
                                        <?php if (in_array('roles.delete', json_decode(@session('user_permissions')))) { ?>
                                            ...
                                            <td class="delete-all">
                                                ...
                                                <input type="checkbox" id="is_open_{{$role->id}}" class="is_open"
                                                    dataId="{{$role->id}}"><label class="col-3 control-label"
                                                    for="is_open_{{$role->id}}"></label>
                                                @endif
                                            </td>
                                        <?php } ?>
                                        ...
                                        <td class="action-btn">
                                            ...
                                            <?php if (in_array('roles.delete', json_decode(@session('user_permissions')))) { ?>
                                                ...
                                                @if($role->role_name!="Super Administrator")
                                                <a class="delete-btn"
                                                    href="{{route('role.delete', ['userid' => $role->id])}}"><i
