        ...
        <div class="payment-top-tab mt-3 mb-3">
            ...
            <ul class="nav nav-tabs card-header-tabs align-items-end">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link active xendit_active_label" href="{!! url('settings/payments/xendit') !!}"><i
...
<script>
    ...
    $(document).ready(function() {
        ...
        paymentRef.get().then(async function(paymentSnapshots) {
            ...
            var payment=paymentSnapshots.data().xendit;
    ...
    $(".edit-setting-btn").click(function() {
        ...
        var isEnabled=$("#enable_xendit").is(":checked");
        ...
        storeImageData().then(IMG => {
            ...
            database.collection('settings').doc("payment").update({
                ...
                'xendit.enable': isEnabled,

                'xendit.isSandbox': isSandBox,

                'xendit.apiKey': publicKey,

                'xendit.image': IMG

            }).then(function(result) {

                window.location.href='{{ url("settings/payments/xendit")}}';
