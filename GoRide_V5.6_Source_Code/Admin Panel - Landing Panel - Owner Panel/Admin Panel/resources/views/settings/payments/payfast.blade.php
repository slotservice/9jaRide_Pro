    ...
    <div class="card">
        <div class="payment-top-tab mt-3 mb-3">
            <ul class="nav nav-tabs card-header-tabs align-items-end">
                ...
                <li class="nav-item">
                    <a class="nav-link active payfast_active_label" href="{!! url('settings/payments/payfast') !!}"><i
                ...
                <div class="restaurant_payout_create-inner">
                    <fieldset>
                        ...
                        <div class="form-group row width-100">
                            ...
                            <div class="col-7">
                                <input type="password" class=" form-control cancel_url">
                            </div>
                        </div>
                        ...
                        <div class="form-group row width-100">
                            ...
                            <div class="col-7">
                                <input type="password" class=" form-control notify_url">
                            </div>
                        </div>
                        ...
                        <div class="form-group row width-100">
                            ...
                            <div class="col-7">
                                <input type="password" class=" form-control return_url">
                            </div>
                        </div>
                        <div class="form-group row width-100">
