    ...
    <div class="card">
        <div class="payment-top-tab mt-3 mb-3">
            <ul class="nav nav-tabs card-header-tabs align-items-end">
                ...
                <li class="nav-item">
                    <a class="nav-link active paystack_active_label" href="{!! url('settings/payments/paystack') !!}"><i
                ...
                <div class="restaurant_payout_create-inner">
                    <fieldset>
                        ...
                        <div class="form-group row width-100">
                            ...
                            <div class="col-7">
                                <input type="password" class=" form-control callbackURL">
                            </div>
                        </div>
                        ...
                        <div class="form-group row width-100">
                            ...
                            <div class="col-7">
                                <input type="password" class=" form-control webhookURL">
                            </div>
                        </div>
                        <div class="form-group row width-100">
