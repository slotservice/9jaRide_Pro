            ...
            <ul class="nav nav-tabs card-header-tabs align-items-end">
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link  cod_active_label" href="{!! url('settings/payments/cod') !!}"><i
                            class="fa fa-envelope-o mr-2"></i>{{trans('lang.app_setting_cod_short')}}<span class="badge ml-2"></span>
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link active midtrans_active_label" href="{!! url('settings/payments/midtrans') !!}"><i
                    ...
                    <fieldset>
                        ...
                        <div class="form-group row width-100">
                            ...
                            <div class="col-7">
                                ...
                                <input type="file" class=" col-7 form-control" onChange="handleFileSelect(event)">
...
<script>
    ...
    $(document).ready(function() {
        ...
        paymentRef.get().then(async function(paymentSnapshots) {
            ...
            var payment=paymentSnapshots.data().midtrans;
    ...
    $(".edit-setting-btn").click(function() {
        ...
        storeImageData().then(IMG => {
            ...
            database.collection('settings').doc("payment").update({
                ...
                'midtrans.enable': isEnabled,

                'midtrans.isSandbox': isSandBox,
                ...
                window.location.href='{{ url("settings/payments/midtrans")}}';
