...
<div class="page-wrapper">
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor">{{trans('lang.create_admin')}}</h3>
        </div>

        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{url('/dashboard')}}">{{trans('lang.dashboard')}}</a></li>
                <li class="breadcrumb-item"><a href="{!! route('admin.users.index') !!}">{{trans('lang.admin_plural')}}</a>
                </li>
                <li class="breadcrumb-item">{{trans('lang.create_admin')}}</li>
            ...
            <div class="column">
                <form method="post" action="{{ route('admin.users.store') }}">
                        ...
                        <div class="restaurant_payout_create-inner">
                            <fieldset>
                                ...
                                <div class="form-group row width-50">
                                    <label class="col-5 control-label">{{trans('lang.password')}}</label>
                                    <div class="col-7">
                                ...
                                <div class="form-group row width-50">
                                    ...
                                    <div class="col-7">
                                        <input type="text" class=" col-6 form-control" name="email">
                                        <div class="form-text text-muted">
                    ...
                    <div class="form-group col-12 text-center btm-btn">
                        <button type="submit" class="btn btn-primary  save-form-btn" id="save_user_btn"><i
