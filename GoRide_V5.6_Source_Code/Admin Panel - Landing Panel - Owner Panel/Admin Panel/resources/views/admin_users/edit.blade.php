    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{!! route('admin.users.index') !!}">{{trans('lang.user_profile')}}</a></li>
    ...
    <div class="profile-form">
        ...
        <div class="card-body">
            ...
            <div class="form-group col-12 text-center btm-btn">
                <button type="submit" class="btn btn-primary  edit-form-btn" id="save_user_btn"><i
