                    ...
                    <div class="col-12">
                        <div class="d-flex top-title-section pb-4 justify-content-between">
                            <div class="d-flex top-title-left align-self-center">
                                ...
                                <h3 class="mb-0">{{ trans('lang.fleet_driver_table') }}</h3>
...
@section('scripts')
    <script type="text/javascript">
        ...
        if (urlParams.has('today')) {
            ...
            var ref = database.collection('driver_users').where("createdAt", ">=", startOfDay).where("createdAt", "<=", endOfDay).where('ownerId', '!=', null).orderBy('ownerId');
        } else {
            var ref = database.collection('driver_users').where('ownerId', '!=', null).orderBy('ownerId');
        }        
        ...
        $(document).ready(function() {
            ...
            const table = $('#driverTable').DataTable({
                ...
                ajax: async function(data, callback, settings) {
                    ...
                    const orderableColumns = (checkDeletePermission) ? ['', 'fullName', 'email', 'phone', 'createdAt',  'serviceName', 'totalRide', ''] : ['fullName', 'email', 'phone', 'createdAt','service', 'totalRide', '']; // Ensure this matches the actual column names
