...
<div class="page-wrapper">
    ...
    <script>
        var docId="{{$id}}";
        var id="{{$driverId}}";
        var alldriver=database.collection('driver_users').where('id','==',id);
        ...
        async function getDocId() {
            var enableDocIds=[];
            await database.collection('documents').where('isDeleted','==',false).where('enable',"==",true).where('type','==','driver').get().then(async function(snapshots) {
